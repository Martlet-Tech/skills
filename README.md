...
| Skill | Description |
|---|---|
| [`dsh-configure-codebuddy`](dsh-configure-codebuddy/SKILL.md) | Configure DeepSeek Harness (DSH) to route models through the Tencent CodeBuddy / WorkBuddy subscription gateway — credentials, the hand-declared `llm-pi-ai` route, gateway dialect quirks, and enabling image input. |
